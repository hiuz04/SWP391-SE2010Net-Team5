...
public class Booking implements Serializable {
    ...
    public Long getFacilityId() { return facilityId; } public void setFacilityId(Long facilityId) { this.facilityId = facilityId; }
    public Long getFieldId() { return fieldId; } public void setFieldId(Long fieldId) { this.fieldId = fieldId; }
    public Long getRecurringGroupId() { return recurringGroupId; } public void setRecurringGroupId(Long recurringGroupId) { this.recurringGroupId = recurringGroupId; }
    ...
    public LocalDateTime getHoldExpiresAt() { return holdExpiresAt; } public void setHoldExpiresAt(LocalDateTime holdExpiresAt) { this.holdExpiresAt = holdExpiresAt; }
