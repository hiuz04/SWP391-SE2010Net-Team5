    ...
    <%@ page import="java.util.Collections" %>
        <%@ page import="java.util.Map" %>
            <%@ page import="com.swp.util.RecaptchaConfig" %>
                <% if (request.getAttribute("googleEnabled")==null) { response.sendRedirect(request.getContextPath()
                    + "/register" ); return; } String ctx=request.getContextPath(); String
                    fullName=request.getAttribute("fullName") !=null ? (String) request.getAttribute("fullName") : "" ;
                    ...
                    ? (Map<String, String>) request.getAttribute("fieldErrors")
                        ...
                        <body>
                            <div id="navbar" data-root="<%= ctx %>/" data-role="guest" data-name="" data-active="">
                            </div>
                                            ...
                                            <div class="card soft-card p-4 p-lg-5">
                                                ...
                                                <% if (!error.isEmpty()) { %>
                                                    ...
                                                    <% } %>
                                                        ...
                                                        <form id="registerForm" action="<%= ctx %>/register"
                                                            method="post" novalidate>
                                                            <input type="hidden" name="csrfToken"
                                                                value="<%= session.getAttribute("csrfToken") != null ? session.getAttribute("csrfToken") : "" %>">
                                                            <div class="row g-3">
                                                                <div class="col-md-6">
                                                                    <label class="form-label" for="fullName">Họ tên
                                                                        <span class="text-danger">*</span></label>
                                                                    <input id="fullName" name="fullName"
                                                                        class="form-control <%= fullNameClass %>"
                                                                        placeholder="Nguyễn Văn A"
                                                                        value="<%= fullName %>" minlength="2"
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input id="phone" name="phone"
                                                                        ...
                                                                        inputmode="numeric" pattern="0[35789][0-9]{8}"
                                                                        required>
                                                                    <div class="invalid-feedback"
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-text">Ít nhất 6 ký tự, gồm chữ cái
                                                                        và chữ số.</div>
                                                                    <div class="invalid-feedback"
                                                            ...
                                                            <div class="mt-4 d-flex justify-content-center">
                                                                <div class="g-recaptcha"
                                                                    data-sitekey="<%= RecaptchaConfig.getSiteKey() %>">
                                                                </div>
                                                            </div>

                                                            <button type="submit"
                                                                class="btn btn-sf-primary btn-lg w-100 mt-4">Tạo tài
                                                                khoản</button>
                                                        </form>
                                                        ...
                                                        <% if (googleEnabled) { %>
                                                            ...
                                                            <% } %>
                                                                ...
                                                                <p class="text-center mt-4 mb-0">
                                                                    Đã có tài khoản? <a href="<%= ctx %>/login">Đăng
                                                                        nhập</a>
                                                                </p>
                                            </div>
                                        </div>
