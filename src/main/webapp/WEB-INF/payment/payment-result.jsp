...
<%
    ...
    boolean membershipPayment = "MEMBERSHIP".equals(payment.getPaymentType());
%>
            ...
            <div class="col-lg-8">
                <div class="card soft-card p-4 p-md-5">
                    <div class="text-center">
                        ...
                        <p class="text-muted"><%= checkoutPayment ? "Hóa đơn checkout đã được thanh toán. Booking đã hoàn tất." : (membershipPayment ? "Thanh toán Gói Hội Viên VIP thành công. Trạng thái VIP của bạn đã được cập nhật." : "Thanh toán thành công. Booking đã được xác nhận.") %></p>
                        <% } else if (failed) { %>
                        <i class="bi bi-x-circle-fill text-danger display-1"></i>
                        <h1 class="fw-bold mt-3">Thanh to&#225;n th&#7845;t b&#7841;i</h1>
                        <p class="text-muted"><%= checkoutPayment ? "Thanh toán thất bại. Hóa đơn vẫn chờ thanh toán và bạn có thể thử lại." : (membershipPayment ? "Thanh toán Gói Hội Viên thất bại. Bạn có thể thử lại." : "Thanh toán thất bại. Bạn có thể thử lại nếu booking còn thời gian giữ chỗ.") %></p>
                        <% } else { %>
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center mt-4">
                        ...
                        <a class="btn btn-danger" href="<%= ctx %>/payment?action=method&type=membership">Th&#7917; thanh to&#225;n l&#7841;i</a>
                        <% } else { %>
                        ...
                        <% } else if (membershipPayment) { %>
                        <a class="btn btn-sf-primary" href="<%= ctx %>/profile">V&#7873; h&#7891; s&#417; VIP</a>
                        <% } else { %>
