<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  <%@ page import="com.swp.model.User" %>
            ...
            <%@ page import="java.util.Map" %>
              <%@ page import="java.time.format.DateTimeFormatter" %>
                <% String ctx=request.getContextPath(); User sessionUser=(User) session.getAttribute("user"); String
                  displayName=sessionUser !=null ? sessionUser.getFullName() : "" ; String navRole=(String)
                  request.getAttribute("navRole"); if (navRole==null) navRole=sessionUser==null ? "guest" : (String)
                  session.getAttribute("navRole"); if (navRole==null) navRole="guest" ; List<FootballComplex> complexes
                  = (List<FootballComplex>) request.getAttribute("complexes");
                    List<User> staffList = (List<User>) request.getAttribute("staffList");
                        List<WorkShift> shifts = (List<WorkShift>) request.getAttribute("shifts");
                            Map<Long, Integer> staffShiftCounts = (Map<Long, Integer>)
                                request.getAttribute("staffShiftCounts");
                                    ...
                                    Map<String, Object> map = new java.util.HashMap<>();
                                        ...
                                        <body>
                                          <div id="navbar" data-root="<%= ctx %>/" data-role="<%= navRole %>"
                                            data-name="<%= displayName %>" data-active="Quản lý ca trực"></div>
                                            ...
                                            <div class="container">
                                              ...
                                              <div class="page-header">
                                                <div class="page-header-left">
                                                  <h1><i class="bi bi-clock-history me-2"></i>Quản lý Ca trực & Phân
                                                    công</h1>
                                                  <p>Thiết lập lịch trực, phân ca làm việc cho nhân viên và quản lý nhân
                                                    sự tại các cơ sở sân bóng.</p>
                                                </div>
                                              ...
                                              <div class="row g-4 mb-4">
                                                <div class="col-md-4">
                                                  <div class="card soft-card p-4">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                      <div>
                                                        <span class="text-muted small fw-semibold">Tổng số nhân
                                                          sự</span>
                                                        <h3 class="fw-bold mt-1 mb-0 text-slate-800">
                                                          <%= staffList.size() %>
                                                        </h3>
                                                      </div>
                                                      <div class="p-3 bg-emerald-50 text-emerald-600 rounded-3"
                                                        style="background:#e6fbf4; color:#10b981;">
                                                ...
                                                <div class="col-md-4">
                                                  <div class="card soft-card p-4">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                      <div>
                                                        <span class="text-muted small fw-semibold">Tổng số ca
                                                          trực</span>
                                                ...
                                                <div class="col-md-4">
                                                  <div class="card soft-card p-4">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                      <div>
                                                        <span class="text-muted small fw-semibold">Cơ sở hoạt
                                                          động</span>
                                                        <h3 class="fw-bold mt-1 mb-0">
                                                          <%= complexes.size() %>
                                                        </h3>
                                                      </div>
                                                      <div class="p-3 bg-amber-50 text-amber-600 rounded-3"
                                              ...
                                              <div
                                                ...
                                                <ul class="nav nav-pills" id="shiftTabs" role="tablist">
                                                  <li class="nav-item" role="presentation">
                                                    <button class="nav-link active" id="shifts-tab" data-bs-toggle="tab"
                                                      data-bs-target="#shifts-panel" type="button" role="tab"
                                                      aria-controls="shifts-panel" aria-selected="true">
                                                ...
                                                <div class="d-flex gap-2">
                                                  <label for="complex-filter" class="visually-hidden">Lọc theo cơ
                                                    sở</label>
                                                  <select class="form-select border-0 shadow-sm" id="complex-filter"
                                                    style="min-width: 220px;" onchange="filterShifts()">
                                                    <option value="ALL">Tất cả cơ sở</option>
                                                    <% for (FootballComplex fc : complexes) { %>
                                                      <option value="<%= fc.getComplexId() %>">
                                                        <%= fc.getComplexName() %>
                                                      </option>
                                                      <% } %>
                                                  </select>
                                              ...
                                              <div class="tab-content" id="shiftTabContent">
                                                ...
                                                <div class="tab-pane fade show active" id="shifts-panel" role="tabpanel"
                                                  aria-labelledby="shifts-tab">
                                                  <div class="card soft-card p-4">
                                                    <div
                                                      class="d-flex justify-content-between align-items-center mb-4 pb-1">
                                                      <h5 class="fw-bold mb-0"><i
                                                          class="bi bi-table text-emerald-600 me-2"
                                                          style="color:#10b981;"></i>Danh sách ca trực đã thiết lập</h5>
                                                      <button
                                                        class="btn btn-danger btn-sm fw-bold px-3 py-2 rounded-3 shadow-sm"
                                                        id="btnDeleteSelected" style="display: none;"
                                                        onclick="deleteSelectedShifts()">
                                                        <i class="bi bi-trash3-fill me-1"></i>Xóa ca đã chọn (<span
                                                          id="selectedCount">0</span>)
                                                      </button>
                                                    </div>

                                                    <!-- Advanced Filters Bar -->
                                                    <div class="row g-3 mb-4 p-3 rounded-3"
                                                      style="background: #f8fafc; border: 1px solid #e2e8f0; margin-left: 0; margin-right: 0;">
                                                      <div class="col-md-3">
                                                        <label for="filter-shift-name"
                                                          class="form-label small fw-bold text-muted mb-1">Tìm theo tên
                                                          ca</label>
                                                        <div class="input-group input-group-sm">
                                                          ...
                                                          <input type="text" class="form-control border-start-0"
                                                            id="filter-shift-name" placeholder="Ví dụ: Ca sáng..."
                                                            onkeyup="filterShifts()">
                                                        </div>
                                                      </div>
                                                      <div class="col-md-3">
                                                        <label for="filter-shift-date"
                                                          class="form-label small fw-bold text-muted mb-1">Lọc theo
                                                          ngày</label>
                                                        <div class="input-group input-group-sm">
                                                          <span
                                                            class="input-group-text bg-white border-end-0 text-muted"><i
                                                          ...
                                                          <input type="date" class="form-control border-start-0"
                                                            id="filter-shift-date" onchange="filterShifts()">
                                                        </div>
                                                      </div>
                                                      <div class="col-md-3">
                                                        <label for="filter-shift-time"
                                                          class="form-label small fw-bold text-muted mb-1">Lọc theo giờ
                                                          trực</label>
                                                        <div class="input-group input-group-sm">
                                                          <span
                                                            class="input-group-text bg-white border-end-0 text-muted"><i
                                                          ...
                                                          <input type="text" class="form-control border-start-0"
                                                            id="filter-shift-time" placeholder="Ví dụ: 08:00..."
                                                            onkeyup="filterShifts()">
                                                        </div>
                                                      </div>
                                                      <div class="col-md-3 d-flex align-items-end">
                                                        <button
                                                          class="btn btn-outline-secondary btn-sm w-100 fw-semibold"
                                                          type="button" onclick="resetFilters()">
                                                          <i class="bi bi-arrow-counterclockwise me-1"></i>Đặt lại bộ
                                                          lọc
                                                        </button>
                                                      </div>
                                                    </div>
                                                        ...
                                                        <thead>
                                                          <tr>
                                                            <th style="width: 40px;"><input type="checkbox"
                                                                id="selectAllShifts"
                                                                onclick="toggleSelectAllShifts(this)"></th>
                                                            <th>Tên ca trực</th>
                                                            <th>Cơ sở</th>
                                                            <th>Ngày trực</th>
                                                            <th>Khung giờ</th>
                                                          ...
                                                          <% if (shifts == null || shifts.isEmpty()) { %>
                                                            ...
                                                            <% } else {
                                                              ...
                                                              for (WorkShift ws : shifts) {
                                                                ...
                                                                boolean isOvernight = ws.getEndTime().isBefore(ws.getStartTime());
                                                                String timeRangeStr = ws.getStartTime().format(timeFormatter) + " - " + ws.getEndTime().format(timeFormatter) + (isOvernight ? " (Sáng hôm sau)" : "");
                                                            %>
                                                              <tr class="shift-row"
                                                                data-complex-id="<%= ws.getComplexId() %>"
                                                                onclick="handleShiftRowClick(event, <%= ws.getShiftId() %>, '<%= ws.getShiftName().replace("'", "\\'") %>', '<%= fcName.replace("'", "\\'") %>', '<%= ws.getShiftDate().format(dateFormatter) %>', '<%= timeRangeStr.replace("'", "\\'") %>', <%= isOngoing %>, <%= isPast %>)">
                                                                <td>
                                                                  <% if (isPast) { %>
                                                                    ...
                                                                    <% } else { %>
                                                                      <input type="checkbox"
                                                                        class="form-check-input shift-checkbox"
                                                                        value="<%= ws.getShiftId() %>"
                                                                        onclick="updateDeleteSelectedButtonVisibility()">
                                                                      <% } %>
                                                                </td>
                                                                <td class="cursor-pointer"
                                                                  title="Nhấn để xem chi tiết ca">
                                                                ...
                                                                <td class="cursor-pointer"
                                                                  ...
                                                                  <span class="text-secondary">
                                                                    <%= ws.getShiftDate().format(dateFormatter) %>
                                                                  </span>
                                                                </td>
                                                                <td class="cursor-pointer"
                                                                  title="Nhấn để xem chi tiết ca">
                                                                  <div
                                                                    ...
                                                                    <span class="stat-badge bg-soft-emerald"><i
                                                                    ...
                                                                    <% if (isOngoing) { %>
                                                                      <span class="badge badge-ongoing"
                                                                        style="font-size: 0.75rem;"><i
                                                                          class="bi bi-broadcast me-1"></i>Đang diễn
                                                                        ra</span>
                                                                      <% } %>
                                                                  </div>
                                                                </td>
                                                                  ...
                                                                  <div class="d-flex align-items-center gap-2">
                                                                    <% if (assigned.isEmpty()) { %>
                                                                      <span class="text-danger small fw-semibold"><i
                                                                          class="bi bi-exclamation-triangle-fill me-1"></i>Chưa
                                                                        phân công</span>
                                                                      <% } else { %>
                                                                        <div class="avatar-stack">
                                                                          <% for (User staff : assigned) { String
                                                                            initials=staff.getFullName().substring(0,
                                                                            Math.min(staff.getFullName().length(),
                                                                            2)).toUpperCase(); %>
                                                                            <div class="avatar-circle"
                                                                              title="<%= staff.getFullName() %> (<%= staff.getPhone() %>)">
                                                                              <%= initials %>
                                                                            </div>
                                                                            <% } %>
                                                                        </div>
                                                                ...
                                                                <td class="text-end">
                                                                  <% if (isPast) { %>
                                                                    <span
                                                                      class="badge bg-secondary-subtle text-secondary px-2.5 py-1.5 border border-secondary-subtle cursor-pointer"
                                                                      onclick="event.stopPropagation(); openShiftDetailModal(<%= ws.getShiftId() %>, '<%= ws.getShiftName().replace("'", "\\'") %>', '<%= fcName.replace("'", "\\'") %>', '<%= ws.getShiftDate().format(dateFormatter) %>', '<%= timeRangeStr.replace("'", "\\'") %>', <%= isOngoing %>, <%= isPast %>)"
                                                                      title="Nhấn để xem chi tiết ca">
                                                                    ...
                                                                    <% } else { %>
                                                                      <div
                                                                        ...
                                                                        <button
                                                                          ...
                                                                          onclick="event.stopPropagation(); openAssignModal(<%= ws.getShiftId() %>, '<%= ws.getShiftName().replace("'", "\\'") %>')">
                                                                          <i class="bi bi-person-plus-fill fs-5"></i>
                                                                        </button>
                                                                        <button
                                                                          class="btn btn-sm btn-outline-primary border-0"
                                                                          title="Sửa ca"
                                                                          onclick="event.stopPropagation(); openEditShiftModal(<%= ws.getShiftId() %>, <%= ws.getComplexId() %>, '<%= ws.getShiftName().replace("'", "\\'") %>', '<%= ws.getShiftDate() %>', '<%= ws.getStartTime() %>', '<%= ws.getEndTime() %>', <%= assignedStaffId != null ? assignedStaffId : "''" %>)">
                                                                          <i class="bi bi-pencil-square fs-5"></i>
                                                                        </button>
                                                                        <button
                                                                          class="btn btn-sm btn-outline-danger border-0"
                                                                          title="Xóa ca"
                                                                          onclick="event.stopPropagation(); deleteShift(<%= ws.getShiftId() %>)">
                                                ...
                                                <div class="tab-pane fade" id="staff-panel" role="tabpanel"
                                                  ...
                                                  <div class="card soft-card p-4">
                                                    <h5 class="fw-bold mb-4"><i
                                                        class="bi bi-people-fill text-emerald-600 me-2"
                                                        style="color:#10b981;"></i>Thông tin nhân sự sân bóng</h5>
                                                    ...
                                                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                                                      <% if (staffList==null || staffList.isEmpty()) { %>
                                                        ...
                                                        <% } else { for (User staff : staffList) { int
                                                          shiftCount=staffShiftCounts.getOrDefault(staff.getUserId(),
                                                          0); %>
                                                          <div class="col">
                                                            <div
                                                              class="staff-card d-flex flex-column justify-content-between h-100">
                                                              <div>
                                                                <div class="d-flex align-items-center gap-3 mb-3">
                                                                  <div
                                                                    class="avatar-circle fs-5 bg-emerald-100 text-emerald-800"
                                                                    style="width:55px; height:55px; background-color:#d1fae5; color:#065f46;">
                                                                    <%= staff.getFullName().substring(0,
                                                                      Math.min(staff.getFullName().length(),
                                                                      2)).toUpperCase() %>
                                                                  </div>
                                                                  <div>
                                                                ...
                                                                <div class="text-secondary small mb-3"><i
                                                                    class="bi bi-envelope me-2"></i>
                                                                  <%= staff.getEmail() %>
                                                                </div>
                                                              </div>
                                                              <div
                                                                class="border-top pt-3 d-flex align-items-center justify-content-between">
                                                                <span class="small text-muted">Số ca trực được
                                                                  giao</span>
                                                                <span class="badge-shift-count">
                                                                  <%= shiftCount %> ca
                                                                </span>
                                                              </div>
                                                            </div>
                                          ...
                                          <div class="modal fade" id="shiftModal" tabindex="-1"
                                            aria-labelledby="shiftModalTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  <h5 class="modal-title fw-bold" id="shiftModalTitle">Thêm ca làm việc
                                                    mới</h5>
                                                ...
                                                <form id="shiftForm" onsubmit="submitShiftForm(event)">
                                                  ...
                                                  <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                      <label for="modal-complex"
                                                        class="form-label small fw-bold text-muted">Cơ sở / Địa
                                                        điểm</label>
                                                    ...
                                                    <div class="mb-3" id="creation-mode-container">
                                                      <label for="modal-create-mode"
                                                        class="form-label small fw-bold text-muted">Chế độ tạo</label>
                                                      <select class="form-select" id="modal-create-mode"
                                                        onchange="toggleCreationMode()">
                                                    ...
                                                    <div class="mb-3" style="display: none;">
                                                      <label for="modal-shift-name"
                                                        class="form-label small fw-bold text-muted">Tên ca làm
                                                        việc</label>
                                                    ...
                                                    <div class="mb-3" id="single-date-container">
                                                      <label for="modal-shift-date"
                                                        class="form-label small fw-bold text-muted">Ngày trực</label>
                                                      <input type="date" class="form-control" id="modal-shift-date"
                                                        required>
                                                    </div>
                                                      ...
                                                      <div class="row">
                                                        <div class="col-6 mb-3">
                                                          <label for="modal-start-date"
                                                            class="form-label small fw-bold text-muted">Từ ngày</label>
                                                          <input type="date" class="form-control" id="modal-start-date">
                                                        </div>
                                                        <div class="col-6 mb-3">
                                                          <label for="modal-end-date"
                                                            class="form-label small fw-bold text-muted">Đến ngày</label>
                                                          <input type="date" class="form-control" id="modal-end-date">
                                                        </div>
                                                      </div>
                                                      <div class="mb-3">
                                                        <label class="form-label small fw-bold text-muted d-block">Lặp
                                                          vào các ngày</label>
                                                        <div class="d-flex flex-wrap gap-2">
                                                          <div class="form-check form-check-inline">
                                                            <input class="form-check-input repeat-day-cb"
                                                              type="checkbox" id="cb-mon" value="1">
                                                            <label class="form-check-label small"
                                                              for="cb-mon">T2</label>
                                                          </div>
                                                          <div class="form-check form-check-inline">
                                                            <input class="form-check-input repeat-day-cb"
                                                              type="checkbox" id="cb-tue" value="2">
                                                            <label class="form-check-label small"
                                                              for="cb-tue">T3</label>
                                                          </div>
                                                          <div class="form-check form-check-inline">
                                                            <input class="form-check-input repeat-day-cb"
                                                              type="checkbox" id="cb-wed" value="3">
                                                            <label class="form-check-label small"
                                                              for="cb-wed">T4</label>
                                                          </div>
                                                          <div class="form-check form-check-inline">
                                                            <input class="form-check-input repeat-day-cb"
                                                              type="checkbox" id="cb-thu" value="4">
                                                            <label class="form-check-label small"
                                                              for="cb-thu">T5</label>
                                                          </div>
                                                          <div class="form-check form-check-inline">
                                                            <input class="form-check-input repeat-day-cb"
                                                              type="checkbox" id="cb-fri" value="5">
                                                            <label class="form-check-label small"
                                                              for="cb-fri">T6</label>
                                                          </div>
                                                          <div class="form-check form-check-inline">
                                                            <input class="form-check-input repeat-day-cb"
                                                              type="checkbox" id="cb-sat" value="6">
                                                            <label class="form-check-label small"
                                                              for="cb-sat">T7</label>
                                                          </div>
                                                          <div class="form-check form-check-inline">
                                                            <input class="form-check-input repeat-day-cb"
                                                              type="checkbox" id="cb-sun" value="7">
                                                            <label class="form-check-label small"
                                                              for="cb-sun">CN</label>
                                                          </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                      <div class="col-6 mb-3">
                                                        <label for="modal-start-time"
                                                          class="form-label small fw-bold text-muted">Giờ bắt
                                                          đầu</label>
                                                      ...
                                                      <div class="col-6 mb-3">
                                                        <label for="modal-end-time"
                                                          class="form-label small fw-bold text-muted">Giờ kết
                                                          thúc</label>
                                                    ...
                                                    <div class="mb-3">
                                                      <label class="form-label small fw-bold text-muted">Nhân viên trực
                                                        ca (Có thể chọn nhiều)</label>
                                                      <div class="dropdown">
                                                        <button
                                                          class="btn btn-outline-secondary w-100 text-start d-flex justify-content-between align-items-center rounded-3 bg-white"
                                                          type="button" id="staffDropdownBtn" data-bs-toggle="dropdown"
                                                          data-bs-auto-close="outside" aria-expanded="false">
                                                          <span id="staffDropdownText" class="text-truncate">-- Chưa
                                                            phân công --</span>
                                                          <i class="bi bi-chevron-down ms-2"></i>
                                                        </button>
                                                        <div class="dropdown-menu w-100 p-2 shadow-sm rounded-3"
                                                          aria-labelledby="staffDropdownBtn"
                                                          style="max-height: 220px; overflow-y: auto;">
                                                          <% if (staffList !=null && !staffList.isEmpty()) { for (User
                                                            staff : staffList) { %>
                                                            <div
                                                              class="dropdown-item d-flex align-items-center gap-2 py-2 px-3 cursor-pointer rounded"
                                                              onclick="toggleStaffCheckbox(event, '<%= staff.getUserId() %>')">
                                                              <input class="form-check-input modal-staff-checkbox m-0"
                                                                type="checkbox" value="<%= staff.getUserId() %>"
                                                                id="staff_chk_<%= staff.getUserId() %>"
                                                                onclick="event.stopPropagation(); updateStaffDropdownText();">
                                                              <label
                                                                class="form-check-label mb-0 cursor-pointer flex-grow-1"
                                                                for="staff_chk_<%= staff.getUserId() %>"
                                                                onclick="event.stopPropagation();">
                                                                <strong class="text-dark">
                                                                  <%= staff.getFullName() %>
                                                                </strong>
                                                                <small class="text-muted ms-1">(<%= staff.getPhone() %>
                                                                    )</small>
                                                              </label>
                                                            </div>
                                                            <% } } else { %>
                                                              <div class="p-2 text-muted small">Không có nhân viên
                                                                active</div>
                                                              <% } %>
                                                        </div>
                                                      </div>
                                                      <input type="hidden" id="modal-staff-id" value="">
                                                    </div>

                                                  </div>
                                                  <div class="modal-footer">
                                                    <button type="button"
                                                      class="btn btn-light px-4 py-2.5 rounded-3 fw-semibold"
                                                      data-bs-dismiss="modal">Đóng</button>
                                                    <button type="submit" class="btn btn-sf-primary px-4 py-2.5"
                                                      id="submitBtn">Lưu ca trực</button>
                                                  </div>
                                                </form>
                                              </div>
                                            </div>
                                          ...
                                          <div class="modal fade" id="shiftDetailModal" tabindex="-1"
                                            aria-labelledby="shiftDetailModalTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                              <div class="modal-content border-0 shadow-lg rounded-4"
                                                style="background:#ffffff; overflow:hidden;">
                                                <div
                                                  class="modal-header border-0 pb-0 px-4 pt-4 d-flex align-items-center justify-content-between">
                                                  <div class="d-flex align-items-center gap-3">
                                                    <div class="avatar-circle fs-5 flex-shrink-0"
                                                      style="width:46px; height:46px; background-color:#d1fae5; color:#065f46; font-weight:700;">
                                                      <i class="bi bi-calendar-event"></i>
                                                    </div>
                                                    <div>
                                                      <h5 class="modal-title fw-bold text-dark fs-5 mb-0"
                                                        id="det-shift-name">Chi tiết ca làm việc</h5>
                                                      <span class="text-muted small" id="det-shift-complex">—</span>
                                                    </div>
                                                  </div>
                                                    ...
                                                    <div class="row g-3">
                                                      <div class="col-6">
                                                        <span class="text-muted small d-block"
                                                          style="font-size:0.75rem;">Ngày trực</span>
                                                        <strong class="text-dark fs-6" id="det-shift-date">—</strong>
                                                      </div>
                                                      <div class="col-6">
                                                        <span class="text-muted small d-block"
                                                          style="font-size:0.75rem;">Khung giờ</span>
                                                        <strong class="text-dark fs-6" id="det-shift-time">—</strong>
                                                      </div>
                                                      <div class="col-12 border-top pt-2 mt-2">
                                                        <span class="text-muted small d-block mb-1"
                                                          style="font-size:0.75rem;">Trạng thái ca trực</span>
                                                        <div id="det-shift-status">—</div>
                                                      </div>
                                                    </div>
                                                  </div>

                                                  <h6 class="fw-bold text-muted small mb-3"
                                                    style="font-size:0.75rem; letter-spacing:0.05em;">
                                                    <i class="bi bi-people-fill me-2" style="color:#10b981;"></i>NHÂN
                                                    VIÊN ĐƯỢC PHÂN CÔNG
                                                  </h6>
                                                  <div id="det-shift-staff-list" class="d-flex flex-column gap-2">
                                                    <!-- Populated dynamically via JS -->
                                                  </div>
                                                </div>
                                                <div
                                                  class="modal-footer border-0 px-4 pb-4 pt-0 d-flex justify-content-end">
                                                  <button type="button"
                                          ...
                                          <div class="modal fade" id="assignModal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  <div>
                                                    <h5 class="modal-title fw-bold" id="assignModalTitle">Phân công nhân
                                                      viên</h5>
                                                    <span class="text-muted small" id="assignModalSub">Ca làm việc:
                                                      <strong class="text-success" id="assignShiftName"></strong></span>
                                                  </div>
                                                  <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body py-4">
                                                  ...
                                                  <h6 class="fw-bold mb-3"><i
                                                      class="bi bi-people-fill text-success me-2"></i>Chọn nhân viên để
                                                    phân công</h6>
                                                  <div class="row row-cols-1 row-cols-md-2 g-3"
                                                    id="assignStaffContainer">
                                                    <!-- Dynamically populated via javascript fetch -->
                                                  </div>
                                                </div>
                                                <div class="modal-footer">
                                                  <button type="button" class="btn btn-sf-primary px-4 py-2.5"
                                                    data-bs-dismiss="modal">Hoàn tất</button>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <script>
                                            /**
                                             * Quản lý trạng thái và khởi tạo các Modal Bootstrap trong trang Quản lý ca trực
                                             */
                                            let shiftModal = null;
                                            ...
                                            function initModals() {
                                              ...
                                              // Tự động điền ngày hôm nay vào modal thêm mới
                                            ...
                                            /**
                                             * Bộ lọc ca trực đa năng: Lọc kết hợp theo Cụm sân, Tên ca trực, Ngày trực và Khung giờ
                                             */
                                            function filterShifts() {
                                              ...
                                              rows.forEach(row => {
                                                ...
                                                // 4. Kiểm tra Khung giờ trực (Cột 5)
                                              ...
                                              // Hiển thị trạng thái bảng trống nếu không có kết quả phù hợp
                                            ...
                                            /**
                                             * Đặt lại tất cả các ô trong thanh bộ lọc nâng cao
                                             */
                                            ...
                                            /**
                                             * Chuyển đổi giữa chế độ Tạo ca đơn lẻ (Single) và Tạo hàng loạt theo dải ngày (Batch)
                                             */
                                            ...
                                            /**
                                             * Escape ký tự đặc biệt HTML tránh lỗi XSS và hiển thị giao diện an toàn
                                             */
                                            ...
                                            /**
                                             * Xử lý click hàng trong bảng ca trực:
                                             * Chỉ mở Popup Chi tiết ca làm việc khi nhấp vào cột 1 đến 5 (Không kích hoạt khi nhấp checkbox hoặc nút thao tác)
                                             */
                                            function handleShiftRowClick(event, shiftId, shiftName, complexName, dateStr, timeStr, isOngoing, isPast) {
                                              if (event.target.closest('button') || event.target.closest('a') || event.target.closest('input')) {
                                                return;
                                              }
                                              const td = event.target.closest('td');
                                              if (!td || td.cellIndex === 0 || td.cellIndex === 6) {
                                                return; // Bỏ qua ô checkbox (Cột 0) và cột Hành động (Cột 6)
                                              }
                                              openShiftDetailModal(shiftId, shiftName, complexName, dateStr, timeStr, isOngoing, isPast);
                                            }

                                            function openShiftDetailModal(shiftId, shiftName, complexName, dateStr, timeStr, isOngoing, isPast) {
                                              document.getElementById('det-shift-name').textContent = shiftName || 'Chi tiết ca làm việc';
                                              document.getElementById('det-shift-complex').textContent = complexName || '—';
                                              document.getElementById('det-shift-date').textContent = dateStr || '—';
                                              document.getElementById('det-shift-time').textContent = timeStr || '—';

                                              const statusEl = document.getElementById('det-shift-status');
                                              if (isOngoing) {
                                                statusEl.innerHTML = '<span class="badge badge-ongoing"><i class="bi bi-broadcast me-1"></i>Đang diễn ra</span>';
                                              } else if (isPast) {
                                                statusEl.innerHTML = '<span class="badge bg-secondary-subtle text-secondary px-3 py-1.5 border border-secondary-subtle"><i class="bi bi-clock-history me-1"></i>Đã kết thúc</span>';
                                              } else {
                                                statusEl.innerHTML = '<span class="badge bg-success-subtle text-success px-3 py-1.5 border border-success-subtle"><i class="bi bi-calendar-check me-1"></i>Sắp diễn ra</span>';
                                              }

                                              const staffContainer = document.getElementById('det-shift-staff-list');
                                              staffContainer.innerHTML = '<div class="text-center text-muted py-3"><div class="spinner-border spinner-border-sm me-2 text-emerald-600"></div>Đang tải danh sách nhân viên...</div>';

                                              fetch('<%= ctx %>/owner/work-shift?action=getAssignments&shiftId=' + shiftId)
                                                .then(res => res.json())
                                                .then(staffList => {
                                                  if (Array.isArray(staffList) && staffList.length > 0) {
                                                    staffContainer.innerHTML = staffList.map(u => {
                                                      const name = u.fullName || 'Nhân viên';
                                                      const initials = name.substring(0, Math.min(name.length, 2)).toUpperCase();
                                                      const phone = (u.phone && u.phone !== 'null' && String(u.phone).trim() !== '') ? u.phone : 'Không có SĐT';
                                                      const email = (u.email && u.email !== 'null' && String(u.email).trim() !== '') ? u.email : 'Không có Email';
                                                      return `
              <div class="d-flex align-items-start gap-3 p-3 rounded-4 border bg-white shadow-sm mb-2">
                <div class="avatar-circle fs-6 flex-shrink-0 mt-1" style="width:44px; height:44px; background-color:#d1fae5; color:#065f46; font-weight:700;">
                  \${initials}
                </div>
                <div class="flex-grow-1 overflow-hidden">
                  <div class="fw-bold text-dark fs-6 mb-1.5 text-truncate">\${escapeHtml(name)}</div>
                  <div class="d-flex flex-column gap-1 text-muted small">
                    <div class="d-flex align-items-center gap-2">
                      <i class="bi bi-telephone-fill text-success" style="width:18px; text-align:center; font-size:0.9rem;"></i>
                      <span>SĐT: <strong class="text-dark">\${escapeHtml(phone)}</strong></span>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                      <i class="bi bi-envelope-fill text-primary" style="width:18px; text-align:center; font-size:0.9rem;"></i>
                      <span>Email: <strong class="text-dark">\${escapeHtml(email)}</strong></span>
                    </div>
                  </div>
                </div>
              </div>`;
                                                    ...
                                                    staffContainer.innerHTML = '<div class="alert alert-warning rounded-4 mb-0 small py-2.5"><i class="bi bi-exclamation-triangle me-1"></i>Ca làm việc này chưa có nhân viên nào được phân công.</div>';
                                                  }
                                                })
                                                .catch(err => {
                                                  staffContainer.innerHTML = '<div class="alert alert-danger rounded-4 mb-0 small py-2.5">Lỗi khi tải thông tin nhân viên: ' + escapeHtml(err.message) + '</div>';
                                                });

                                              bootstrap.Modal.getOrCreateInstance(document.getElementById('shiftDetailModal')).show();
                                            }

                                            function toggleStaffCheckbox(event, userId) {
                                              if (event.target && event.target.tagName === 'INPUT') return;
                                              const cb = document.getElementById('staff_chk_' + userId);
                                              if (cb) {
                                                cb.checked = !cb.checked;
                                                updateStaffDropdownText();
                                              }
                                            }

                                            function updateStaffDropdownText() {
                                              const checked = document.querySelectorAll('.modal-staff-checkbox:checked');
                                              const textEl = document.getElementById('staffDropdownText');
                                              if (!textEl) return;
                                              if (checked.length === 0) {
                                                textEl.textContent = '-- Chưa phân công --';
                                              } else if (checked.length === 1) {
                                                const labelContainer = checked[0].closest('.dropdown-item');
                                                const label = labelContainer ? labelContainer.querySelector('strong') : null;
                                                textEl.textContent = label ? label.textContent : '1 nhân viên';
                                              } else {
                                                textEl.textContent = 'Đã chọn ' + checked.length + ' nhân viên';
                                              }
                                            }
    ...
    `;
                                              ...
                                              document.querySelectorAll('.modal-staff-checkbox').forEach(cb => cb.checked = false);
                                              updateStaffDropdownText();
    ...
    `;
                                              ...
                                              // Fetch assigned staff for this shift
                                              fetch('<%= ctx %>/owner/work-shift?action=getAssignments&shiftId=' + id)
                                                .then(res => res.json())
                                                .then(staffList => {
                                                  if (Array.isArray(staffList)) {
                                                    staffList.forEach(u => {
                                                      const cb = document.getElementById('staff_chk_' + u.userId);
                                                      if (cb) cb.checked = true;
                                                    });
                                                  }
                                                  updateStaffDropdownText();
                                                })
                                                .catch(() => updateStaffDropdownText());
                                            ...
                                            async function submitShiftForm(event) {
                                              ...
                                              const checkedStaffIds = Array.from(document.querySelectorAll('.modal-staff-checkbox:checked')).map(cb => cb.value);
                                              ...
                                              params.append('staffIds', checkedStaffIds.join(','));
