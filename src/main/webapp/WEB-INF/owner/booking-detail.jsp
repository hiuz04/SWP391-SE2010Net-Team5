...
<%
    ...
    String currentName = currentUser != null && currentUser.getFullName() != null ? currentUser.getFullName() : "Owner";
%>
<div id="navbar" data-root="<%= ctx %>/" data-role="owner" data-name="<%= currentName %>" data-active="Dashboard"></div>
...
<main class="dashboard-shell py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="<%= ctx %>/owner/dashboard" class="text-decoration-none text-muted">Dashboard</a></li>
        ...
        <a href="<%= ctx %>/owner/dashboard" class="btn btn-outline-secondary">
