...
<head>
    ...
    <meta name="description" content="Owner Dashboard - Theo dõi hiệu quả kinh doanh cơ sở sân bóng">
    ...
    <main class="owner-content">
        ...
        <div class="row g-4 mb-4">
            <div class="col-xl-3 col-md-6">
                <div class="dashboard-card">
                    ...
                    <h2 id="todayBooking">
                        <span class="skeleton d-inline-block" style="width:60px;height:36px;"></span>
                    </h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="dashboard-card">
                    ...
                    <h2 id="monthRevenue" style="font-size:1.5rem">
                        <span class="skeleton d-inline-block" style="width:100px;height:36px;"></span>
                    </h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="dashboard-card">
                    ...
                    <h2 id="activeFields">
                        <span class="skeleton d-inline-block" style="width:50px;height:36px;"></span>
                    </h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="dashboard-card">
                    ...
                    <span>Voucher</span>
                    <h2>14</h2>
                    <small class="badge-soft-success" style="border-radius:20px;padding:3px 9px;font-size:.75rem">
                        Đang hoạt động
                    </small>
                </div>
            </div>
        ...
        <div class="chart-wrapper">
            <div class="chart-header">
                <div>
                    <h5><i class="bi bi-bar-chart-fill me-2 text-success"></i>Doanh thu 7 ngày gần nhất</h5>
                    <p class="mb-0 text-muted" style="font-size:.8rem">Cập nhật theo thời gian thực</p>
                </div>
                <span class="chart-badge">
                    <i class="bi bi-circle-fill" style="font-size:7px;color:#22c55e"></i>
                    Live
                </span>
            </div>
