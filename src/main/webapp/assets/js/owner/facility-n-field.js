                ...
                html += `
                    ...
                    <div>
                        <div class="card soft-card p-4">
                            ...
                            <a onclick="navigateFacilityFormWithID(${item.facility.facilityId})">Edit</a>
                            <a onclick="deleteFacility(${item.facility.facilityId})">Delete</a>
                            <div class="fields">    
...
function navigateFacilityForm(){
    window.location.href= `${ctx}/UI/owner/facility-form.html`
}
// Với ID
function navigateFacilityFormWithID(id){
    window.location.href= `${ctx}/UI/owner/facility-form.html?id=${id}`
}
